...
(function () {
  ...
  function Dattaopnmdl(src, formattedSrc) {
    document.querySelector(
        '.datta-example-modal-content').innerHTML = '<pre><code class="hljs html xml">'
        + formattedSrc + '</code></pre>';
  ...
  Array.prototype.slice.call(
      document.querySelectorAll('.datta-example')).forEach(function (parentEl) {
