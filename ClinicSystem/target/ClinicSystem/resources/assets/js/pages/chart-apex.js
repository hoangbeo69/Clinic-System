  ...
  setTimeout(function () {
      ...
      var options = {
        ...
        xaxis: {
          ...
          categories: ["2018-09-19T00:00:00", "2018-09-19T01:30:00",
            "2018-09-19T02:30:00", "2018-09-19T03:30:00", "2018-09-19T04:30:00",
    ...
    $(function () {
      var options = {
        ...
        series: [{
          name: 'Net Profit',
          data: [256500, 286000, 356000, 556000, 956000, 856000, 756000, 356000,
            556000, 956000]
        }],
        xaxis: {
    ...
    $(function () {
      ...
      var chart = new ApexCharts(document.querySelector("#checkin-chart"),
          options);
      chart.render();
    });
    ...
    $(function () {
      ...
      var chart = new ApexCharts(document.querySelector("#checkout-chart"),
          options);
      chart.render();
    });
    ...
    $(function () {
      ...
      var chart = new ApexCharts(
          document.querySelector("#available-room-chart"), options);
      chart.render();
    });
