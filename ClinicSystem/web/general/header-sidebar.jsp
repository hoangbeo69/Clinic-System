    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div ">
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="<%=request.getContextPath()%>/user" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">User Information</span></a>
                </li>
                <li class="nav-item">
                    <a href="<%=request.getContextPath()%>/DoctorInformation" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Information</span></a>
                </li>
                <li class="nav-item">
