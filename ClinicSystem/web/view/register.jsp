            ...
            <div class="row align-items-center text-center">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-4">
                            <input type="password" class="form-control" id="Password" name="repassword" placeholder="Confirm password">
                        </div>
                        ...
                        <hr>
                        <p class="mb-2">Already have an account? <a href="<%=request.getContextPath()%>/LoginController" class="f-w-400">Login</a></p>
                        </form>
                    </div>
                </div>
            </div>
