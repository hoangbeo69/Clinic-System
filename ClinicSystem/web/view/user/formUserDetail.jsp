<div class="modal fade" id="formUserDetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required="" class="form-control" name="username" id="username" placeholder="" value="${user.username}">
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <c:if test="${not empty user.id}">
                        <button type="submit" class="btn btn-primary" id="btnUpdateOrAddUser">Edit</button>
                    </c:if>
                    <c:if test="${empty user.id}">
                        <button type="submit" class="btn btn-primary" id="btnUpdateOrAddUser">Create new</button>
                    </c:if>
                </div>
        </form>
    </div>
...
<script src="<c:url value="/js/user/userDetailForm.js" />">  </script>