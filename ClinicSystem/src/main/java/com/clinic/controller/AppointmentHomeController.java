...
@WebServlet(name = "AppointmentHomeController", urlPatterns = {"/appointment"})
public class AppointmentHomeController extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
      throws ServletException, IOException {
    List<BookingAppointmentDto> listBooking = appointmentBookingService.findAll();
    request.setAttribute("appointments", listBooking);
    request.getRequestDispatcher("/views/appointment-home.jsp").forward(request, response);
  }
