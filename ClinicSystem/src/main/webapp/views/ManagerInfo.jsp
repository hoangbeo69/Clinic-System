            ...
            <div class="page">
                <form>
                    ...
                    <div class="input-with-validator">
                        <input type="text" placeholder="" maxlength="255" value="${m.getName()}">
                    </div>
                    <div class="_3cfiVM">
                        <label>Số điện thoại</label>
                    </div>
                    <div class="input-with-validator">
                        <input type="text" placeholder="" maxlength="255" value="${m.getPhone()}">
                    </div>
                    <div class="_3cfiVM">
                        <label>địa chỉ</label>
                    </div>
                    <div class="input-with-validator">
                        <input type="text" placeholder="" maxlength="255" value="${m.getAddress()}">
                    </div>
                    <div class="_3cfiVM">
                        <label>Email</label>
                    </div>
                    <div class="input-with-validator">
                        <input type="text" placeholder="" maxlength="255" value="${m.getEmail()}">
                    </div>
                    <div class="_3cfiVM">
                        <label>Ngày sinh</label>
                    </div>
                    <div class="input-with-validator">
                        <input type="text" placeholder="" maxlength="255" value="${m.getDOB()}">
                    </div>
