...
$(document).ready(function () {
  ...
  $(".mob-toggler").on('click', function () {
    $('.pcoded-header > .collapse,.pcoded-header > .container > .collapse').toggleClass(
        'd-flex');
  });
...
function menuhrres() {
  ...
  if (vw < 992) {
    setTimeout(function () {
      ...
      $(".theme-horizontal").addClass("theme-horizontal-dis").removeClass(
          "theme-horizontal");
    }, 400);
  } else {
    setTimeout(function () {
      ...
      $(".theme-horizontal-dis").addClass("theme-horizontal").removeClass(
...
$(window).scroll(function () {
  ...
  if (vw >= 768) {
    ...
    if (cOst == 400) {
      ...
      $('.theme-horizontal').addClass('top-nav-collapse').removeClass(
          'default');
    } else {
  ...
  var PcodedMenu = {
    ...
    HandleSubMenuTrigger: function () {
      ...
      if ($('.pcoded-navbar').hasClass('theme-horizontal') == true || $(
        ...
        if ((newSize >= 992 && $('body').hasClass('layout-6') || (newSize >= 992
          ...
          if ($('body').hasClass('layout-6') || $('body').hasClass(
              'layout-7')) {
            if ($('.pcoded-navbar').hasClass('theme-horizontal-dis')) {
              var $dropdown = $(
                  ...
                  function () {
                    ...
                    if (str === 0) {
                      if ($(this).hasClass('pcoded-trigger')) {
                        ...
                        $('.pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger').children(
                            '.pcoded-submenu').slideUp();
                        $(this).closest('.pcoded-inner-navbar').find(
                            'li.pcoded-trigger').removeClass('pcoded-trigger');
                  ...
                  'click', function (e) {
                    ...
                    if (str === 0) {
                      if ($(this).hasClass('pcoded-trigger')) {
                        ...
                        $('.pcoded-hasmenu li.pcoded-trigger').children(
                            '.pcoded-submenu').slideUp();
                        $(this).closest('.pcoded-inner-navbar').find(
                            'li.pcoded-trigger').removeClass('pcoded-trigger');
                        $(this).addClass('pcoded-trigger');
    ...
    HandleMenuTrigger: function () {
      ...
      if (newSize >= 992) {
        if ($('.pcoded-navbar').hasClass('theme-horizontal') == true) {
          if ((newSize >= 768 && $('body').hasClass('layout-6') || (newSize
              >= 768 && $('body').hasClass('layout-7')))) {
            var $dropdown = $(
                    ...
                    if (!isEntirelyVisible) {
                      ...
                      $('.sidenav-inner').css({
                        'margin-left': (parseInt(
                            temp.slice(12, temp.length - 3)) - 80)
                      });
            ...
            if ($('body').hasClass('layout-6') || $('body').hasClass(
              ...
              if ($('.pcoded-navbar').hasClass('theme-horizontal-dis')) {
                ...
                $dropdown.off('click').off('mouseenter mouseleave').hover(
                    ...
                    function () {
                      $(this).removeClass('pcoded-trigger').removeClass(
                          'active');
                    }
                );
              }
...
$(".pcoded-navbar .pcoded-inner-navbar a").each(function () {
  ...
  if (!$('body').hasClass('layout-14')) {
    if (this.href == pageUrl && $(this).attr('href') != "") {
      ...
      if (!$('.pcoded-navbar').hasClass('theme-horizontal')) {
        $(this).parent('li').parent().parent('.pcoded-hasmenu').addClass(
            "active").addClass("pcoded-trigger");
        $(this).parent('li').parent().parent('.pcoded-hasmenu').parent().parent(
            '.pcoded-hasmenu').addClass("active").addClass("pcoded-trigger");
      }
      ...
      $(this).parent('li').parent().parent().parent().parent().parent().parent(
          '.sidelink').addClass("active");
